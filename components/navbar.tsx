          ...
          <div className="flex flex-col p-4 gap-1">
            ...
            <div className="border-t border-border mt-2 pt-3 flex flex-col gap-2">
              ...
              <Link
                href="/contact"
                tabIndex={mobileOpen ? 0 : -1}
                className="inline-flex items-center justify-center gap-2 text-sm font-medium py-3 px-4 rounded-lg border border-border text-foreground hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
              >
                Contact
              </Link>
              <Link
